...
configuration do |c|
  ...
  # default value: "packaging_example"
  #
  #c.project_name = "packaging_example"
  ...
  # default value: []
  #
  c.files_to_copy = Dir.glob("lib/java/lwjgl/native/#{TARGET_PLATFORM}/*")
  ...
  # default value: ""
  #
  c.java_library_path = "lib/java/lwjgl/native/#{TARGET_PLATFORM}"
